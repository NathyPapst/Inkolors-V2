...
class howToView: UIView {
    ...
    public func setLabel(sizeFont:CGFloat, align:NSTextAlignment, w:UIFont.Weight) -> UILabel{
        ...
        lbl.numberOfLines = 0
        lbl.translatesAutoresizingMaskIntoConstraints = false
        lbl.text = "In this game, we have three types of medals you can win. One bronze, one silver and one gold. Each one you receive according to the stage you're in. \n\nAs you progress through the levels the badges you gain are of higher value. \n\nDrag the splashes of color into the empty circles, completing all of them and advancing to the next levels."
